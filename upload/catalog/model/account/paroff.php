<?php
class ModelAccountParoff extends Model {
	public function addReturn($data) {
		$this->db->query("INSERT INTO `" . DB_PREFIX . "paroff` SET firstname = '" . $this->db->escape($data['firstname']) . "', lastname = '" . $this->db->escape($data['lastname']) . "', email = '" . $this->db->escape($data['email']) . "', company = '" . $this->db->escape($data['company']) . "', age = '" . $this->db->escape($data['age']) . "', form = '" . $this->db->escape($data['form']) . "', document = '" . $this->db->escape($data['document']) . "', comment = '" . $this->db->escape($data['comment']) . "'");
